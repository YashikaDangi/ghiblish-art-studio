...
export default function DreamchantSuccessMessage({ paymentDetails, onReset }: SuccessMessageProps) {
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-2xl mx-auto p-6 font-sans">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-8">
          Thank you for your order. We'll start transforming your photos into magical art.
        </p>
      </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="text-left">
              ...
              <p className="text-2xl font-bold text-gray-800">{paymentDetails.imageCount} Images</p>
            </div>
